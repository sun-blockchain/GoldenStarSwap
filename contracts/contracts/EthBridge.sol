...
contract EthBridge {
    ...
    */
    ...
    function lockToken(
        ...
        emit Locked(addrTokenERC, msg.sender, _actualAmount, _price, _result , recipient);
    }
    ...
    function lockTokenFor(
        ...
        uint256 _price = uint256(getLatestPrice(oracleAddr));
        uint256 _result = _price * _actualAmount;
        emit Locked(addrTokenERC, userAddr, _actualAmount, _price, _result , recipient);
    }
    ...
    function unlockToken(
        ...
        emit Unlocked(addrTokenERC, amount, price, _result, recipient, receiptId);
